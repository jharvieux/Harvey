...
export const CORPUS: CorpusEntry[] = [
  ...
  { id: "P-DEP-CVE", kind: "positive", cls: "Known-vulnerable dependency", location: "lodash", match: ["lodash"], expectedTier: "review", note: "lodash@4.17.11 (prototype-pollution CVE). Caught by OSV-Scanner over the committed package-lock.json (issue #65)." },
  ...
  { id: "P-SLOPSQUAT", kind: "positive", cls: "Slopsquatted / hallucinated dep", location: "react-supabase-helpers", match: ["react-supabase-helpers"], expectedTier: "review", note: "Nonexistent package in deps. Caught at high by checkSlopsquat's live npm-registry existence cross-check (issue #66) — the offline typosquat corpus only catches edit-distance-1 names, so this is the check that actually catches it." },
  ...
  { id: "N-DEV-DEP", kind: "negative", cls: "Vulnerable dep in devDependencies only", location: "webpack", note: "webpack@4.42.0 is dev-only. Excluded from the count; live OSV run (issue #65) over the committed lockfile finds zero CVEs on webpack itself (its dev-only transitive deps do have review-tier, non-curated CVEs, never high)." },
