...
export const b23D091GapEntries: CorpusEntry[] = [
  ...
  },
  {
    ...
    expectedTier: "none",
    gapKind: "by-design",
    note: "D-091 item 27. MEASURED 2026-07-27: zero findings for this class. BOUNDARY, and consistent with the sibling it extends: item 20 (WEBHOOK-REPLAY, b17-race-unscoped.entries.ts, #353/#425) is already a documented by-design LLM-tier gap for exactly this reason. A rule would have to prove the ABSENCE of a version/timestamp comparison anywhere reachable from the handler — including inside an imported wrapper an AST pass cannot follow — and an absence proof at that reach is what makes the rule unshippable, not the ordering concept.",
  },
];
