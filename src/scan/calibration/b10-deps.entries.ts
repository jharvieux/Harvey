...
export const b10DepsEntries: CorpusEntry[] = [
  ...
  { id: "P-NEXT-CVE-NULLORIGIN", kind: "positive", cls: "Framework CVE — Next Server Actions null-origin CSRF (CVE-2026-27978)", location: VULN, match: ["27978"], expectedTier: "high", note: "next@16.0.5 falls in the CVE-2026-27978 range (>=16.0.1 <16.1.7, GHSA-mq59-m269-xvcx); checkNextVersionCVEs's 4th row emits DEP-CVE-2026-27978 at high. 16.0.5 also (correctly) trips the RSC-RCE and WS-SSRF ranges on the same manifest — those are distinct findings; match on the CVE number to isolate this class. Carried a descriptive id and a 'synthetic advisory' note until #212's OSV check found the real CVE." },
