...
export const m8IntentEntries: HeuristicEntry[] = [
  ...
  { module: M8, id: "M8INT-P-SHAPE-ONLY", kind: "positive", cls: "Asserts response shape, not business values", taxonomy: "M8 — Asserts response shape, not business values", dir: "test-intent/shape-only/positive", note: "Body parsed, only status/count/existence asserted — 'asserts WHAT not WHY' mechanized (#821)." },
  ...
  { module: M8, id: "M8INT-N-SHAPE-ONLY", kind: "negative", cls: "Value-asserting / denial / smoke-test route tests", taxonomy: "M8 — Asserts response shape, not business values", dir: "test-intent/shape-only/negative", note: "Cleared by a business-value assertion on the body, a specific error status (denial), toHaveLength(0) emptiness, and a body-less status smoke test (#821)." },
