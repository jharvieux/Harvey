...
// Three of the corpus's 5 suite-carrying targets score their OWN suite unmodified (proposit,
// boxyhq, inbox-zero, rallly — #1268 added the latter two); multi-tenant-starter is the fifth,
// scored since #1496 through a DELIBERATELY DIFFERENT mechanism (below). Two more (saas-lite,
// carbon) remain blocked, each for a MEASURED reason below rather than the generic "no config"
// this file used to assert for all of them.
//
