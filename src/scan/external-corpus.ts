...
export const EXTERNAL_CORPUS: ExternalTarget[] = [
  ...
  },
  {
    ...
    modules: {
      ...
      "M5-slop": {"counted":68,"total":71,"note":"#1818: RE-MEASURED 2026-08-04 at 68/71 against refreshed Saas-Lite pin 63892cee. The change from 73/76 is upstream corpus evolution; this remains the corpus drift watch for helper/JSDoc granularity."},
