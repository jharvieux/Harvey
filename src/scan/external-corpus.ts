...
export const EXTERNAL_CORPUS: ExternalTarget[] = [
  ...
  },
  {
    ...
    modules: {
      ...
      "M4": {"counted":49,"total":55,"note":"#1818: RE-MEASURED 2026-08-04 at 49/55 against refreshed Saas-Lite pin 63892cee via pnpm corpus-drift --target saas-lite --install. This is upstream corpus evolution from the former 17/22 pin, not scanner drift on identical source."},
