...
const PROTECTED_NAMES = /^(?:PATH|HOME|USERPROFILE|TMP|TEMP|TMPDIR|CI|LANG|LC_ALL|NO_COLOR|NODE_OPTIONS|NODE_PATH|BASH_ENV|ENV|SHELLOPTS|CDPATH|IFS|COMSPEC|PATHEXT|HTTP_PROXY|HTTPS_PROXY|ALL_PROXY|NO_PROXY|XDG_.*|GIT_.*|LD_.*|DYLD_.*|NPM_CONFIG_.*|PNPM_.*|YARN_.*|COREPACK_.*)$/;
