// dup/report-a.ts — weekly usage report, section A.
...
export function buildWeeklyReportA(rows: UsageRow[]): Record<string, number> {
  const summary: Record<string, number> = {};

  // PLANTED CLONE (M4-P-CLONE-B): identical >=50-line metric-aggregation
  // block, copy-pasted into report-b.ts instead of being extracted into a
  // shared helper.
