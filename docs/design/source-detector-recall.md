...
never blend the real-code figure into 38/39, or either into the M1 mixed figure (218/221 as measured 2026-07-24 — a
...
pass/fail gate, never blended into the 38/39 headline number or the real-code figure. `validate-source-recall.ts`
